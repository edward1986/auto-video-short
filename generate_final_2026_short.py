...
def generate():
    ...
    # Accent Glow (Neon Green / Electric Blue)
    glow = create_gradient_glow(
        resolution, main_duration, color=[(0, 255, 128), (0, 128, 255)], opacity=0.15
    )
    # Focus Vignette
    ...
    # Transition Flash at 2.0s
    flash = create_flash_transition(resolution).set_start(2.0)

    # 4. Content - Hook (0-2s)
    hook = create_hook_clip(
        "STOP SCROLLING", video_size=resolution, duration=2.0, font=font_path
    )
    ...
    script_data = [
        {"word": "THE FUTURE", "start": 3.0, "end": 4.5},
        {"word": "OF DESIGN", "start": 4.5, "end": 6.0},
        {"word": "IS MINIMAL", "start": 6.0, "end": 7.5},
        {"word": "BOLD", "start": 7.5, "end": 8.5},
        {"word": "AND KINETIC", "start": 8.5, "end": 10.0},
        {"word": "STAY AHEAD", "start": 10.0, "end": 11.5},
        {"word": "OF THE", "start": 11.5, "end": 12.5},
        {"word": "TRENDS", "start": 12.5, "end": 15.0},
    ]
